<script lang="ts">
	...
	import {getChatListByUserId, deleteChatById, getArchivedChatList, getGroupChatListByUserId} from '$lib/apis/chats';
	...
	const deleteChatHandler = async (chatId) => {
		...
		chats = await getGroupChatListByUserId(localStorage.token, user.id);
	};
								...
								<tbody>
									{#each chats.sort((a, b) => {
										...
										>
											...
											<td class="px-3 py-1 text-right hidden">
